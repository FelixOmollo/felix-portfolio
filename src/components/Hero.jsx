    ...
    {/* <div className="absolute inset-0 bg-gray-400 bg-opacity-40 z-0"></div> */}
      ...
      <div className=" relative z-1 px-4 sm:ml-5 sm:px-0 lg:ml-20 sm:space-y-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center sm:justify-center sm:items-center gap-4 md:gap-20 md:mt-15 lg:gap-15 lg:mt-6 mt-6">
            <a href="public\Felix_Odhiambo_GIS_CV.pdf" download className="bg-blue-700 text-white lg:text-xl md:text-xl px-6 md:px-7 py-3 rounded-b-4xl rounded-t-2xl shadow hover:bg-blue-800 transition">Download CV</a>
            <a href="#projects" className="mt-6 inline-block bg-blue-700 text-white lg:text-xl px-6 py-3 md:text-xl md:px-7 rounded-t-4xl rounded-b-2xl shadow hover:bg-blue-800 transition">Geospatial Portfolio</a>
        </div>
                                {/* Scroll down */}
        <div className=" absolute text-sm rotate-0 md:text-lg text-gray-400 animate-pulse mt-30 md:mt-60 sm:mt-22 lg:mt-34">Scroll down ↓</div>
      </div>
