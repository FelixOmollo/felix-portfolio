     ...
     <div className="absolute inset-0 bg-black/50">
        <div className="max-w-6xl mx-auto px-4 text-white">
          ...
          <div className="mt-20 md:mt-25 transition-transform duration-500 active:scale-115">
            <a href="/#contact" className="text-sm md:text-lg mr-4 bg-amber-400 py-3 px-8 rounded-2xl text-white hover:text-blue-700 font-bold transition-all duration-300">Let’s Connect</a>
          </div>
